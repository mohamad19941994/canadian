        ...
        <div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">@lang('site.appointments')</h5>
                    <!--end::Page Title-->
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm mr-4">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{route('admin.appointments.index')}}" class="text-muted">@lang('site.appointments')</a>
                        </li>
                        <li class="breadcrumb-item">
                ...
                <div class="card card-custom gutter-t">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">@lang('site.appointments')</h3>
                        </div>
                        <div class="card-toolbar">
                            ...
                            @if (auth()->user()->hasPermission('delete_appointments'))
                                <form method="post" action="{{ route('admin.appointments.bulk_delete') }}" style="display: inline-block;">
                                    @csrf
                                    @method('delete')
...
@push('scripts')
    ...
    <script>
        let appointmentsTable = $('#kt_datatable').DataTable({
            responsive: true,
            searchDelay: 500,
            dom:
