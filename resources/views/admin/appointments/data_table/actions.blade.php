@if (auth()->user()->hasPermission('update_appointments'))
...
@if (auth()->user()->hasPermission('delete_appointments'))
    ...
    <form action="{{ route('admin.appointments.destroy', $id) }}" class="my-1 my-xl-0" id="my_form" method="post" style="display: inline-block;">
        @csrf
        @method('delete')
