                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm mr-4">
                        ...
                        <li class="breadcrumb-item">
                            <a href="https://demo.tajraa.com/cp/blog_post_service_categories" class="text-muted">@lang('site.service_categories')</a>
                        </li>
                        <li class="breadcrumb-item">
        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                ...
                <div class="card card-custom gutter-b example example-compact" data-card="true">
                    ...
                    <!--begin::Form-->
                    <form id="validatable-form" class="form validatable-form" method="post" action="{{ route('admin.service_categories.store') }}">
                        @csrf
                        @method('post')
                        <div class="card-body">
                            <div class="row">
