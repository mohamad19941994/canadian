        ...
        <div class="d-flex flex-column-fluid">
            ...
            <!--begin::Card-->
                <div class="card card-custom gutter-b example example-compact" data-card="true">
                    ...
                    <!--begin::Form-->
                    <form id="contact_form" class="form validatable-form" method="post" action="" >
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input name="name" type="text" class="form-control" placeholder="@lang('site.name')" value="{{ $contact[0]->name }}" disabled/>
                                </div>
                                {{--email--}}
                                <div class="form-group col-lg-6">
                                    <label>@lang('site.email') <span class="text-danger">*</span></label>
                                    <input name="email" type="email" class="form-control"  placeholder="@lang('site.email')" value="{{ $contact[0]->email }}" disabled/>
                                </div>
                                {{--phone--}}
                                <div class="form-group col-lg-6">
                                    <label>@lang('site.phone')<span class="text-danger">*</span></label>
                                    <input name="phone" type="text" class="form-control" value="{{ $contact[0]->phone }}" disabled/>
                                </div>

                                {{--message--}}
                                <div class="form-group col-lg-6">
                                    <label>@lang('site.message')<span class="text-danger">*</span></label>
                                    <textarea name="message" type="text" class="form-control" disabled >{{ $contact[0]->message }}</textarea>
                                </div>
                            </div>
                        </div>
                    </form>
