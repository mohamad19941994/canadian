                                        ...
                                        <div class="tab-pane lang-tab-pane fade {{($locale == 'ar') ?  'show active' : ''}}" id="{{$locale}}" data-locale="{{$locale}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="{{$locale}}[subhead]" class="form-control lang_fields_{{$locale}}" type="text" value="{{old($locale . '.subhead')}}" placeholder="أكتب @lang('site.' . $locale . '.subhead')" >
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="{{$locale}}[name]" class="form-control lang_fields_{{$locale}}" type="text" value="{{old($locale . '.name')}}" placeholder="أكتب @lang('site.' . $locale . '.name')">
                                                </div>
                                                <span class="form-text text-muted">قم بكتابة @lang('site.' . $locale . '.name')</span>
                                            </div>
                                            {{--description--}}
                                            <div class="form-group col-lg-12">
                                                ...
                                                <textarea name="{{$locale}}[description]" rows="3" placeholder="أكتب الوصف" class="form-control lang_fields_{{$locale}}">{{old($locale . '.description')}}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="{{$locale}}[button_name]" class="form-control lang_fields_{{$locale}}" type="text" value="{{old($locale . '.button_name')}}" placeholder="أكتب @lang('site.' . $locale . '.button_name')">
                                                </div>
                                                <span class="form-text text-muted">قم بكتابة @lang('site.' . $locale . '.button_name')</span>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="{{$locale}}[button_url]" class="form-control lang_fields_{{$locale}}" type="text" value="{{old($locale . '.button_url')}}" placeholder="أكتب @lang('site.' . $locale . '.button_url')">
                                                </div>
                                                <span class="form-text text-muted">قم بكتابة @lang('site.' . $locale . '.button_url')</span>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
