        ...
        <div class="d-flex flex-column-fluid">
            ...
            <!--begin::Card-->
                <div class="card card-custom gutter-b example example-compact" data-card="true">
                    ...
                    <!--begin::Form-->
                    <form id="validatable-form" class="form validatable-form" method="post" action="{{ route('admin.page_categories.update', $pageCategory->id) }}">
                        @csrf
                        @method('put')
                        <div class="card-body">
                            <div class="row">
                                        ...
                                        <div class="tab-pane lang-tab-pane fade {{($locale == 'ar') ? 'show active' : ''}}" id="{{$locale}}" data-locale="{{$locale}}">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="{{$locale}}[name]" class="form-control lang_fields_{{$locale}}" type="text" value="{{ $pageCategory->translate($locale)->name }}" placeholder="أكتب العنوان" required="required">
                                                </div>
