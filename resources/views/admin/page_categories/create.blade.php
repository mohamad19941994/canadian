                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm mr-4">
                        ...
                        <li class="breadcrumb-item">
                            <a href="https://demo.tajraa.com/cp/blog_post_page_categories" class="text-muted">@lang('site.page_categories')</a>
                        </li>
                        <li class="breadcrumb-item">
        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                ...
                <div class="card card-custom gutter-b example example-compact" data-card="true">
                    ...
                    <!--begin::Form-->
                    <form id="validatable-form" class="form validatable-form" method="post" action="{{ route('admin.page_categories.store') }}" data-locale="{{$locale}}">
                        @csrf
                        @method('post')
                        <div class="card-body">
                            <div class="row">
