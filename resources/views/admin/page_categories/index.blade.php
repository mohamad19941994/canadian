        ...
        <div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">@lang('site.page_categories')</h5>
                    <!--end::Page Title-->
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm mr-4">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{route('admin.page_categories.index')}}" class="text-muted">@lang('site.page_categories')</a>
                        </li>
                        <li class="breadcrumb-item">
                    ...
                    <!--end::Breadcrumb-->
                    <!--begin::Actions-->
                    <a href="{{route('admin.page_categories.create')}}" class="btn btn-light-success font-weight-bolder btn-sm m-1">@lang('site.add_new')</a>
                    <!--end::Actions-->
                </div>
                <!--end::Info-->
            </div>
                ...
                <div class="card card-custom gutter-t">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">@lang('site.page_categories')</h3>
                        </div>
                        <div class="card-toolbar">
                            @include('admin.partials._session')
                            <!--begin::Button-->
                            <a href="{{route('admin.page_categories.create')}}" class="btn btn-primary font-weight-bolder mr-2"><i class="la la-plus"></i>@lang('site.add_new')</a>
                            <!--end::Button-->
                            <!--begin::Button-->
                            @if (auth()->user()->hasPermission('delete_page_categories'))
                                <form method="post" action="{{ route('admin.page_categories.bulk_delete') }}" style="display: inline-block;">
                                    @csrf
                                    @method('delete')
...
@push('scripts')
    ...
    <script>
        let page_categoriesTable = $('#kt_datatable').DataTable({
            responsive: true,
            searchDelay: 500,
            dom:
            ...
            ajax: {
                url: '{{route('admin.page_categories.data')}}',
        ...
        $('#data-table-search').keyup(function () {
            page_categoriesTable.search(this.value).draw();
        })
    </script>
