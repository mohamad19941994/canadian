                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm mr-4">
                        ...
                        <li class="breadcrumb-item">
                            <a href="https://demo.tajraa.com/cp/blog_post_doctor_categories" class="text-muted">@lang('site.doctor_categories')</a>
                        </li>
                        <li class="breadcrumb-item">
        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                ...
                <div class="card card-custom gutter-b example example-compact" data-card="true">
                    ...
                    <!--begin::Form-->
                    <form id="validatable-form" class="form validatable-form" method="post" action="{{ route('admin.doctor_categories.store') }}" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="image-input image-input-outline image-input-changed" id="kt_image_4" style="background-image: url('https://ui-avatars.com/api/?name=مثال&color=000&background=03A9F4');">
