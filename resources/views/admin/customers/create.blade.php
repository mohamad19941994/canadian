                                        ...
                                        <div class="tab-pane lang-tab-pane fade {{($locale == 'ar') ? 'show active' : ''}}" id="{{$locale}}" role="tabpanel" aria-labelledby="kt_tab_pane_2" data-locale="{{$locale}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="{{$locale}}[name]" class="form-control lang_fields_{{$locale}}" type="text" value="{{old($locale . '.name')}}" placeholder="أكتب @lang('site.' . $locale . '.customer_name')" required="required">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="{{$locale}}[job]" class="form-control lang_fields_{{$locale}}" type="text" value="{{old($locale . '.job')}}" placeholder="أكتب @lang('site.' . $locale . '.customer_name')" required="required">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="{{$locale}}[comment]" class="form-control lang_fields_{{$locale}}" type="text" value="{{old($locale . '.comment')}}" placeholder="أكتب @lang('site.' . $locale . '.customer_name')" required="required">
                                                </div>
