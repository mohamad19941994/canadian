        ...
        <div class="d-flex flex-column-fluid">
            ...
            <!--begin::Card-->
                <div class="card card-custom gutter-b example example-compact" data-card="true">
                    ...
                    <!--begin::Form-->
                    <form id="validatable-form" class="form validatable-form" method="post" action="{{ route('admin.works.store') }}" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        <div class="card-body">
                            <div class="row">
                                        ...
                                        <div class="tab-pane lang-tab-pane fade {{($locale == 'ar') ? 'show active' : ''}}" id="{{$locale}}" data-locale="{{$locale}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea name="{{$locale}}[subhead]" class="form-control lang_fields_{{$locale}}" type="text" placeholder="أكتب @lang('site.' . $locale . '.subhead')" required="required">{{old($locale . '.subhead')}}</textarea>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="{{$locale}}[customer]" class="form-control lang_fields_{{$locale}}" type="text" value="{{old($locale . '.customer')}}" placeholder="أكتب @lang('site.' . $locale . '.customer')" required="required">
                                                </div>
                                            ...
                                            <div class="form-group col-lg-12">
                                                ...
                                                <textarea name="{{$locale}}[description]" rows="3" id="{{$locale}}_my_tiny" placeholder="أكتب الوصف" class="form-control lang_fields_{{$locale}}">{{old($locale . '.description')}}</textarea>
                                ...
                                <div class="form-group col-lg-3">
                                    ...
                                    <input name="languages" type="text" class="form-control" placeholder="@lang('site.languages')" value="{{ old('languages') }}"/>
                                </div>
                                {{--url_site--}}
                                <div class="form-group col-lg-3">
                                    <label>@lang('site.url_site')<span class="text-danger">*</span></label>
                                    <input name="url_site" type="text" class="form-control" placeholder="@lang('site.url_site')" value="{{ old('url_site') }}"/>
                                </div>
                                {{--url_video--}}
                                <div class="form-group col-lg-3">
                                    <label>@lang('site.url_video')<span class="text-danger">*</span></label>
                                    <input name="url_video" type="text" class="form-control" placeholder="@lang('site.url_video')" value="{{ old('url_video') }}"/>
                                </div>
                                {{--image_video--}}
                                <div class="form-group col-lg-12">
