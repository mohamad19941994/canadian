                                        ...
                                        <div class="tab-pane lang-tab-pane fade {{($locale == 'ar') ? 'show active' : ''}}" id="{{$locale}}_video" role="tabpanel" aria-labelledby="kt_tab_pane_2" data-locale="{{$locale}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="{{$locale}}[name]" class="form-control lang_fields_{{$locale}}" type="text" value="{{ $video->translate($locale)->name }}" placeholder="أكتب العنوان" required="required">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="{{$locale}}[meta_title]" class="form-control lang_fields_{{$locale}}" type="text" value="{!! $video->translate($locale)->meta_title !!}" placeholder="أكتب @lang('site.' . $locale . '.meta_title')" required="required">
                                                </div>
                                            ...
                                            <div class="form-group col-lg-12">
                                                ...
                                                <textarea name="{{$locale}}[meta_description]" rows="3" placeholder="أكتب @lang('site.' . $locale . '.meta_description')" class="form-control lang_fields_{{$locale}}">{!! $video->translate($locale)->meta_description !!}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="{{$locale}}[keywords]" class="form-control lang_fields_{{$locale}}" type="text" value="{!! $video->translate($locale)->keywords !!}" placeholder="أكتب @lang('site.' . $locale . '.keywords')" required="required">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="{{$locale}}[image_alt]" class="form-control lang_fields_{{$locale}}" type="text" value="{!! $video->translate($locale)->image_alt !!}" placeholder="أكتب @lang('site.' . $locale . '.image_alt')" required="required">
                                                </div>
