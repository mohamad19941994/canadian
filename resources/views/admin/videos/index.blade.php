        ...
        <div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">@lang('site.videos')</h5>
                    <!--end::Page Title-->
                    ...
                    <!--end::Breadcrumb-->
                    <!--begin::Actions-->
                    <a href="{{route('admin.videos.create')}}" class="btn btn-light-success font-weight-bolder btn-sm m-1">@lang('site.add_new')</a>
                    <!--end::Actions-->
                </div>
                <!--end::Info-->
            </div>
                ...
                <div class="card card-custom gutter-t">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">@lang('site.videos')</h3>
                        </div>
                        <div class="card-toolbar">
                            @include('admin.partials._session')
                            <!--begin::Button-->
                            <a href="{{route('admin.videos.create')}}" class="btn btn-primary font-weight-bolder mr-2"><i class="la la-plus"></i>@lang('site.add_new')</a>
                            <!--end::Button-->
                            <!--begin::Button-->
                            @if (auth()->user()->hasPermission('delete_videos'))
                                <form method="post" action="{{ route('admin.videos.bulk_delete') }}" style="display: inline-block;">
                                    @csrf
                                    @method('delete')
...
@push('scripts')
    ...
    <script>
        let videosTable = $('#kt_datatable').DataTable({
            responsive: true,
            searchDelay: 500,
            dom:
