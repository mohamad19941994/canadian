        ...
        <div class="d-flex flex-column-fluid">
            ...
            <!--begin::Card-->
                <div class="card card-custom gutter-b example example-compact" data-card="true">
                    ...
                    <!--begin::Form-->
                    <form id="validatable-form" class="form validatable-form" method="post" action="{{ route('admin.pages.update', $page->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <select name="page_category_id" class="form-control" id="form_select">
                                        <option value="">@lang('site.select_category')</option>
                                        @foreach($categories as $category)
                                            <option value="{{$category->id}}" {{ $category->id == $page->page_category_id ? 'selected' : ''  }}>{{$category->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                        ...
                                        <div class="tab-pane lang-tab-pane fade {{($locale == 'ar') ? 'show active' : ''}}" id="{{$locale}}" data-locale="{{$locale}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="{{$locale}}[name]" class="form-control lang_fields_{{$locale}}" type="text" value="{{ $page->translate($locale)->name }}" placeholder="أكتب العنوان" required="required">
                                                </div>
                                            ...
                                            <div class="form-group col-lg-12">
                                                ...
                                                <textarea name="{{$locale}}[description]" rows="3" placeholder="أكتب الوصف" class="form-control">{!! $page->translate($locale)->description !!}</textarea>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="image-input image-input-outline image-input-circle" id="kt_image_3">
                                            <div class="image-input-wrapper" style="background-image: url({{asset('storage/page_images/'.$page->image)}});"></div>
                                ...
                                <div class="form-group row">
                                    <label class="col-6 col-form-label">إظهار بالهيدر</label>
                                    <div class="col-6">
                                        <span class="switch switch-outline switch-icon switch-success">
                                            <label>
                                                <input type="checkbox" value="1" {{($page->header_show == "1" ? 'checked="checked"': '')}} name="header_show">
                                                <span></span>
                                            </label>
                                        </span>
                                    </div>
                                    <label class="col-6 col-form-label">صفحة مميزة</label>
                                    <div class="col-6">
                                        <span class="switch switch-outline switch-icon switch-success">
                                            <label>
                                                <input type="checkbox" value="1" {{($page->special == "1" ? 'checked="checked"': '')}} name="special">
                                                <span></span>
                                            </label>
                                        </span>
                                    </div>
