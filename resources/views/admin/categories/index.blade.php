                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm mr-4">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{route('admin.categories.index')}}" class="text-muted">@lang('site.categories')</a>
                        </li>
                        <li class="breadcrumb-item">
                    ...
                    <!--end::Breadcrumb-->
                    <!--begin::Actions-->
                    <a href="{{route('admin.categories.create')}}" class="btn btn-light-success font-weight-bolder btn-sm m-1">@lang('site.add_new')</a>
                    <!--end::Actions-->
                </div>
                <!--end::Info-->
            </div>
                ...
                <div class="card card-custom gutter-t">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">@lang('site.categories')</h3>
                        </div>
                        <div class="card-toolbar">
                            @include('admin.partials._session')
                            <!--begin::Button-->
                            <a href="{{route('admin.categories.create')}}" class="btn btn-primary font-weight-bolder mr-2"><i class="la la-plus"></i>@lang('site.add_new')</a>
                            <!--end::Button-->
                            <!--begin::Button-->
...
@push('scripts')
    ...
    <script>
        let categoriesTable = $('#kt_datatable').DataTable({
            responsive: true,
            searchDelay: 500,
            dom:
