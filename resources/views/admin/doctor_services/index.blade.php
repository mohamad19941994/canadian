        ...
        <div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <!--end::Breadcrumb-->
                    <!--begin::Actions-->
                    <a href="{{route('admin.doctor_services.create')}}" class="btn btn-light-success font-weight-bolder btn-sm m-1">@lang('site.add_new')</a>
                    <!--end::Actions-->
                </div>
                <!--end::Info-->
            </div>
                ...
                <div class="card card-custom gutter-t">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">@lang('site.doctor_services')</h3>
                        </div>
                        <div class="card-toolbar">
                            @include('admin.partials._session')
                            <!--begin::Button-->
                            <a href="{{route('admin.doctor_services.create')}}" class="btn btn-primary font-weight-bolder mr-2"><i class="la la-plus"></i>@lang('site.add_new')</a>
                            <!--end::Button-->
                            <!--begin::Button-->
                            @if (auth()->user()->hasPermission('delete_doctor_services'))
                                <form method="post" action="{{ route('admin.doctor_services.bulk_delete') }}" style="display: inline-block;">
                                    @csrf
                                    @method('delete')
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-hover table-checkable sortable" id="kt_datatable" style="margin-top: 13px !important">
                            ...
                            <tr>
                                ...
                                <th>@lang('site.doctor_category')</th>
...
@push('scripts')
    ...
    {{--<script src="{{asset('admin/assets/js/doctors/crud/datatables/data-sources/ajax-server-side.js')}}"></script>--}}

    <script>
        let doctor_servicesTable = $('#kt_datatable').DataTable({
            responsive: true,
            searchDelay: 500,
            dom:
            ...
            ajax: {
                url: '{{route('admin.doctor_services.data')}}',

            },
            columns: [
                {data: 'record_select', name: 'record_select', searchable: false, sortable: false},
                {data: 'name', name: 'name'},
                {data: "doctor_category.name", name: 'doctor_category.name', defaultContent: "-"},
        ...
        $('#data-table-search').keyup(function () {
            doctor_servicesTable.search(this.value).draw();
        })
    </script>
