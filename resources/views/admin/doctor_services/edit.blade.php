                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm mr-4">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{route('admin.doctor_services.index')}}" class="text-muted">@lang('site.doctor_services')</a>
                        </li>
                        <li class="breadcrumb-item">
        ...
        <div class="d-flex flex-column-fluid">
            ...
            <!--begin::Card-->
                <div class="card card-custom gutter-b example example-compact" data-card="true">
                    ...
                    <!--begin::Form-->
                    <form id="validatable-form" class="form validatable-form" method="post" action="{{ route('admin.doctor_services.update', $doctorService->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <select name="doctor_category_id" class="form-control" id="form_select">
                                        ...
                                        @foreach($doctor_categories as $d_category)
                                            <option value="{{$d_category->id}}" {{ $doctorService->doctor_category_id == $d_category->id ? 'selected' : ''  }}>{{$d_category->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                        ...
                                        <div class="tab-pane lang-tab-pane fade {{($locale == 'ar') ? 'show active' : ''}}" id="{{$locale}}" data-locale="{{$locale}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="{{$locale}}[name]" class="form-control lang_fields_{{$locale}}" type="text" value="{{ $doctorService->translate($locale)->name }}" placeholder="أكتب العنوان" required="required">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="{{$locale}}[description]" id="{{$locale}}_my_tiny" rows="3" placeholder="أكتب @lang('site.' . $locale . '.description')" class="form-control lang_fields_{{$locale}}">{{ $doctorService->translate($locale)->description }}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="{{$locale}}[reasons]" rows="3" placeholder="أكتب @lang('site.' . $locale . '.reasons')" class="form-control lang_fields_{{$locale}}">{{ $doctorService->translate($locale)->reasons }}</textarea>
