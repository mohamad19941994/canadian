        ...
        <div class="d-flex flex-column-fluid">
            ...
            <!--begin::Card-->
                <div class="card card-custom gutter-b example example-compact" data-card="true">
                    ...
                    <!--begin::Form-->
                    <form id="validatable-form" class="form validatable-form" method="post" action="{{ route('admin.doctors.store') }}" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        <div class="card-body">
                            <div class="row">
                                ...
                                {{--doctor_services--}}
                                <div class="form-group col-lg-12" id="products"></div>
                                        ...
                                        <div class="tab-pane lang-tab-pane fade {{($locale == 'ar') ? 'show active' : ''}}" id="{{$locale}}" data-locale="{{$locale}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="{{$locale}}[meta_title]" class="form-control lang_fields_{{$locale}}" type="text" value="{{old($locale . '.meta_title')}}" placeholder="أكتب @lang('site.' . $locale . '.meta_title')">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="{{$locale}}[keywords]" class="form-control lang_fields_{{$locale}}" type="text" value="{{old($locale . '.keywords')}}" placeholder="أكتب @lang('site.' . $locale . '.keywords')">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="{{$locale}}[image_alt]" class="form-control lang_fields_{{$locale}}" type="text" value="{{old($locale . '.image_alt')}}" placeholder="أكتب @lang('site.' . $locale . '.image_alt')">
                                                </div>
...
@push('scripts')
    ...
    <script>
        ...
        /*document.getElementById('form_select').addEventListener("change", function (e) {
            console.log(e);
            if (e.target.value === 1) {
                console.log('aaaaaaa');
