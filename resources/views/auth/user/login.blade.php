        ...
        <div class="d-flex flex-column flex-row-fluid position-relative p-7 overflow-hidden">
            ...
            <div class="d-flex flex-column-fluid flex-center mt-30 mt-lg-0">
                ...
                <div class="login-form login-signin">
                    ...
                    <!--begin::Form-->
                    <form class="form validatable-form" novalidate="novalidate" id="kt_login_signin_form" method="POST" action="{{ route('user.login') }}">
                        @csrf
                        {!!  GoogleReCaptchaV3::renderField('contact_us_id','contact_us_action') !!}
                        {{--Phone--}}
                        <div class="form-group">
                            <input name="phone" class="form-control form-control-solid h-auto py-5 px-6" type="text" placeholder="@lang('site.phone')"  required="required" autofocus="autofocus" aria-invalid="false">
                        </div>
                        @if ($errors->has('phone'))
                            <div class="fv-plugins-message-container">
                                <div data-field="phone" data-validator="notEmpty" class="fv-help-block">{{ $errors->first('phone') }}</div>
                            </div>
                        @endif
                        @if(session('error_phone'))
                            ...
                            {{--<div class="alert alert-danger fade show" role="alert">
                                ...
                                <div class="alert-text">@lang('site.error_phone')</div>
                            </div>--}}
                            <div class="fv-plugins-message-container">
                                <div data-field="phone" data-validator="notEmpty" class="fv-help-block">@lang('site.error_phone')</div>
                            </div>
                        @endif
