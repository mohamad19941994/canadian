            ...
            <div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
                ...
                <ul class="menu-nav">
                    <li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here menu-item-active" data-menu-toggle="click" aria-haspopup="true">
                        ...
                        <a href="{{route('/')}}" target="_blank"><button type="button" class="btn btn-outline-primary mr-2">عرض الموقع</button></a>
            ...
            <div class="dropdown">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                        <img src="{{(app()->getLocale() == 'ar') ? asset('admin/assets/media/svg/flags/020-iraq.webp') : asset('admin/assets/media/svg/flags/226-united-states.svg')}}" alt="{{app()->getLocale()}}" class="h-20px w-20px rounded-sm">
                    </div>
                </div>
                <!--end::Toggle-->
                <!--begin::Dropdown-->
                            ...
                            <li class="navi-item">
                                <a href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}" class="navi-link">
                                    <span class="symbol symbol-20 mr-3">
                                        <img src="{{($localeCode == 'ar') ? asset('admin/assets/media/svg/flags/020-iraq.webp') : asset('admin/assets/media/svg/flags/226-united-states.svg')}}" alt="{{app()->getLocale()}}">
                                    </span>
