...
<head>
    ...
    <!-- SITE TITLE -->
    <title>@if(setting(app()->getLocale())['title']){{setting(app()->getLocale())['title']}}@else@lang('site.title')@endif - @lang('site.dr_ahmad')</title>
    @yield('post_head')
...
<body>
<a href="https://bit.ly/3exfDiE" class="whatsapp-float"><img width="40" src="{{asset('img/whatsapp.png')}}"></a>
<a href="tel:966533385571" class="phone-float"><img width="37" src="{{asset('img/phone.png')}}"></a>
<!-- PRELOADER SPINNER
============================================= -->
                    ...
                    <div class=" breadcrumb-holder">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">@lang('site.dr_ahmad')</li>
                            </ol>
                        </nav>

                        <!-- Title -->
                        <h4 class="h4-sm steelblue-color">@lang('site.dr_ahmad')</h4>
                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="info-4-img text-center wow fadeInUp" data-wow-delay="0.6s">
                            <img class="img-fluid my_border_radius" src="{{url('/thumbnail/900/900/80/storage/settings/'.setting('dr_ahmad'))}}" alt="info-image">
                        </div>
                    </div>
                    <!-- INFO TEXT -->
                    <div class="col-lg-6">
                        <div class="txt-block pc-30 wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <div class=" mb-40" >
                                <form name="" class="row contact-form" action="{{ route('landing.post') }}#landing-sent" method="POST">
                                    <input type="hidden" name="type" value="dr-ahmad">
                                    {{ csrf_field() }}
                                    <!-- Contact Form Input -->
                                    ...
                                    <!-- Form Select -->
                                    <div  class="col-md-12 col-lg-12">
                                        <label for="">@lang('site.service_type')</label><br>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" value="dr_ahmad_1" id="customRadioInline1" name="service" class="custom-control-input">
                                            <label class="custom-control-label" for="customRadioInline1">@lang('site.dr_ahmad_1')</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" value="dr_ahmad_2" id="customRadioInline2" name="service" class="custom-control-input">
                                            <label class="custom-control-label" for="customRadioInline2">@lang('site.dr_ahmad_2')</label>
                                        </div>
                                    </div>
                                    <!-- Contact Form Button -->
