...
@section('page_title')@lang('site.nutrition_offers')@endsection
@section('content')
    <!-- BREADCRUMB
			============================================= -->
                    ...
                    <div class=" breadcrumb-holder">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">@lang('site.nutrition_offers')</li>
                            </ol>
                        </nav>

                        <!-- Title -->
                        <h4 class="h4-sm steelblue-color">@lang('site.nutrition_offers')</h4>
                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="info-4-img text-center wow fadeInUp" data-wow-delay="0.6s">
                            <img class="img-fluid my_border_radius" src="{{url('/thumbnail/900/900/80/storage/settings/'.setting('nutrition_offers'))}}" alt="info-image">
                        </div>
                    </div>
                    <!-- INFO TEXT -->
                    <div class="col-lg-6">
                            ...
                            <!-- CONTACT FORM -->
                                ...
                                <div class=" mb-40" >
                                    <form name="" class="row contact-form" action="{{ route('landing.post') }}#landing-sent" method="POST">
                                        <input type="hidden" name="type" value="nutrition-offers">
                                        {{ csrf_field() }}
                                        <!-- Contact Form Input -->
                                        ...
                                        <div  class="col-md-12 col-lg-12">
                                            <select id="inlineFormCustomSelect3" name="service" class="custom-select " required>
                                                ...
                                                <option value="nutrition_offers_1">@lang('site.nutrition_offers_1')</option>
                                                <option value="nutrition_offers_2">@lang('site.nutrition_offers_2')</option>
                                                <option value="nutrition_offers_3">@lang('site.nutrition_offers_3')</option>
                                            </select>
                                        </div>
                                        <!-- Contact Form Button -->
