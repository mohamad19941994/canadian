...
@section('page_title')@lang('site.blogs')@endsection
@section('content')
    <!-- BREADCRUMB
			============================================= -->
                    ...
                    <div class=" breadcrumb-holder">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">@lang('site.blogs')</li>
                            </ol>
                        </nav>

                        <!-- Title -->
                        <h4 class="h4-sm steelblue-color">@lang('site.blogs')</h4>
