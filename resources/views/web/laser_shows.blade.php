...
@section('page_title')@lang('site.laser_shows')@endsection
@section('content')
    <!-- BREADCRUMB
			============================================= -->
                    ...
                    <div class=" breadcrumb-holder">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">@lang('site.laser_shows')</li>
                            </ol>
                        </nav>

                        <!-- Title -->
                        <h4 class="h4-sm steelblue-color">@lang('site.laser_shows')</h4>
                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="info-4-img text-center wow fadeInUp" data-wow-delay="0.6s">
                            <img class="img-fluid my_border_radius" src="{{url('/thumbnail/900/900/80/storage/settings/'.setting('laser_shows'))}}" alt="info-image">
                        </div>
                    </div>
                    <!-- INFO TEXT -->
                    <div class="col-lg-6">
                            ...
                            <!-- CONTACT FORM -->
                                ...
                                <div class=" mb-40" >
                                    <form name="" class="row contact-form" action="{{ route('landing.post') }}#landing-sent" method="POST">
                                        <input type="hidden" name="type" value="laser-shows">
                                        {{ csrf_field() }}
                                        <!-- Contact Form Input -->
                                        ...
                                        <div  class="col-md-12 col-lg-12">
                                            <select id="inlineFormCustomSelect3" name="service" class="custom-select " required>
                                                ...
                                                <option value="laser_shows_1">@lang('site.laser_shows_1')</option>
                                                <option value="laser_shows_2">@lang('site.laser_shows_2')</option>
                                                <option value="laser_shows_3">@lang('site.laser_shows_3')</option>
                                                <option value="laser_shows_4">@lang('site.laser_shows_4')</option>
                                                <option value="laser_shows_5">@lang('site.laser_shows_5')</option>
                                            </select>
                                        </div>
