...
class MoyasarController extends Controller
{
    ...
    public function callback(Request $request)
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => "https://api.tap.company/v2/charges/".$input['moyasar_id'],
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 30,
        ...
        if ($responseTap->status == 'CAPTURED') {
            ...
            return redirect()->route('moyasar.form')->with('success','Payment Successfully Made.');
        }

        return redirect()->route('moyasar.form')->with('error','Something Went Wrong.');
    }
}
